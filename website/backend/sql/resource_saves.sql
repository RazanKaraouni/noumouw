-- Parent bookmarks for Learn resources (separate from likes).
...
CREATE INDEX IF NOT EXISTS idx_resource_saves_parent
  ON public.resource_saves (parent_user_id);

CREATE INDEX IF NOT EXISTS idx_resource_saves_resource
